...
\item patients with an age lower than 25 years (resident in Latium)[\setword{3}{Word:young}] vs. patients with an age greater or equal than 25 years (resident in Latium) [\setword{4}{Word:old}]
\end{itemize}
...
\clearpage
\noindent
\subsection{Pronto soccorso dataset}\label{analysis:2}
...
\clearpage
\subsection{Ricoveri dataset}\label{analysis:3}
